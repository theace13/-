...
offline_bot_token = "MTE3MTg4NDY2OTk0ODY3NDE0OA.GQ2NCl.QuYqF26MYhD4j6_MfifhLu4wmlv3qghIOoIZHE"
online_bot_token = "MTE3MTg4NDY2OTk0ODY3NDE0OA.GQ2NCl.QuYqF26MYhD4j6_MfifhLu4wmlv3qghIOoIZHE"
...
def add_to_guild(access_token, userID , guild_Id, key_type):
    tkn = offline_bot_token if key_type == 'offline' else online_bot_token
    while True:
